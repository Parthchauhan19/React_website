    ...
    <footer className="bg-neutral-100 text-center text-neutral-600  pt-5 dark:bg-neutral-700 dark:text-neutral-200 lg:text-left font-nunito">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
        ...
        <div className="flex justify-center">
          ...
          <a className="mr-6 text-neutral-600 dark:text-neutral-200 hover:text-red-500 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
          ...
          <a className="text-neutral-600 dark:text-neutral-200 hover:text-red-500 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              fill="currentColor"
