          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-2 py-2 border border-gray-300 text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full text-black px-2 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent pr-10"
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full flex items-center justify-center px-4 py-2 border text-gray-900 border-gray-300 rounded-full hover:bg-gray-50 transition-colors"
              >
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center px-4 py-2 text-gray-900 border border-gray-300 rounded-full hover:bg-gray-50 transition-colors"
              >
                <svg
