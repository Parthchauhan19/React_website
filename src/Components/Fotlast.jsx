  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a className="mr-6 text-neutral-400 dark:text-neutral-200 hover:text-red-500 hover:scale-120 cursor-pointer">
            <svg
          ...
          <a className="mr-6 text-neutral-600 dark:text-neutral-200 hover:text-red-500 hover:scale-120 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
              ...
              fill="currentColor"
            >
              <path d="M714.3 593.1L1179.2 0H1074.4L661.4 512.5L320.5 0H0L486.2 699.6L0 1227H104.8L540.2 678.7L899.4 1227H1200L714.3 593.1ZM600 613.3L545.5 533.7L140.9 90.1H284.4L600 543.9L919.8 90.1H1059.1L652.1 537.5L600 613.3Z" />
            </svg>
          </a>
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div data-aos="zoom-in-up" data-aos-duration="2000" className="">
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start cursor-pointer hover:text-red-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
              ...
              Ahemdabad, Gujarat (380065), INDIA
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start cursor-pointer hover:text-red-600">
              <svg
                xmlns="http://www.w3.org/2000/svg"
